	...
	<body>
		<div class="headerBar">
			<div class="topBar">
				<div class="comWidth">
					<div class="leftArea">
						<a href="#" class="collection">收藏——# 哼！鸿星尔克大傻逼 #——</a>
					</div>
					<div class="rightArea">
						欢迎来到本站！
						<?php if(isset($_SESSION['loginFlag'])):?>
						<span>欢迎您：&nbsp</span><?php echo $_SESSION['username'];?>
						<a href="doAction.php?act=userOut">&nbsp[退出]</a>
						<?php else:?>
			...
			<div class="logoBar">
				<div class="comWidth">
					<div class="logo fl">
						<a href="index.php"><img width="120" height="60" src="images/logo.jpg" alt="logo"></a>
					</div>
					...
					<div class="shopClass fl">
						...
						<div class="shopClass_show">
							<dl class="shopClass_item">
								...
								<dd><a href="#">Moto X</a> <a href="#">单反</a> <a href="#">智能设备</a></dd>
							</dl>
							<dl class="shopClass_item">
								<dt><a href="#" class="b">手机</a> <a href="#" class="b">数码</a> <a href="#" class="aLink">合约机</a></dt>
								<dd><a href="#">Moto X</a> <a href="#">单反</a> <a href="#">智能设备</a></dd>
