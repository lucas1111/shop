	...
	<div class="headerBar">
		<div class="topBar">
			<div class="comWidth">
				...
				<div class="rightArea">
					欢迎来到本站！<a href="login.php">[登录]</a><a href="reg.php">[免费注册]</a>
				</div>
			</div>
		</div>
		<div class="logoBar">
			<div class="comWidth">
				<div class="logo fl">
					<a href="index.php">
						<img width="120" height="60" src="images/logo.jpg" alt="logo">
					</a>
				</div>
		...
		<div class="rightArea">
			<div class="des_infoContent">
				...
				<div class="info_text">
					<div class="hr_45"></div>
					<div class="info_tit">
						<h3>商品详情</h3>货比三家，还选</h4>
					</div>
					<p><h3>
						<?php if($proInfo['pDesc']):echo $proInfo['pDesc'];endif;?>
					</h3></p>
				</div>				
