<?php 
	...
	checkLogined();
	/* getAllCate()--category.inc.php */
	$rows=getAllCate();
	if(!$rows){
		/*alertMes函数--common.func.php*/
		alertMes("没有相应分类，请先添加分类!!", "addCategory.php");
	}
?>
...
<html>
	...
	<body>
		...
		<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
			...
			<tr>
				<td align="right">商品网站价</td>
				<td><input type="text" name="iPrice"  placeholder="请输入商品网站价"/></td>
			</tr>
			<tr>
