<?php 
	...
	//得到数据库中所有商品
	$sql="select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.iPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName from product as p join category c on p.cId=c.id {$where}  ";
                    ...
                    <tr>
                        ...
                        <td align="center">
                        	...
                        	<table class="table" cellspacing="0" cellpadding="0">
                        		...
                        		<tr>
                        			<td  width="20%"  align="right">网站价格</td>
			...
			function showDetail(id,t){
				...
				function search(){
					if(event.keyCode==13){
						...
						window.location="listProduct.php?keywords="+val;
					}
				}
				function change(val){
					window.location="listProduct.php?order="+val;
				}
		</script>
	</body>
</html>