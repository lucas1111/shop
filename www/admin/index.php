<?php 
    ...
    /*函数checkLogined()位于core/admin.inc.php*/
    checkLogined();
?>
    ...
    <div class="content clearfix">
        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    <li onclick="show('menu1','change1')">
                        <h3><span  id="change1">+</span>商品管理</h3>
                        <dl id="menu1" style="display:none;">
                        	<dd><a href="addProduct.php" target="mainFrame">添加商品</a></dd>
                            <dd><a href="listProduct.php" target="mainFrame">商品列表</a></dd>
                        </dl>
                    </li>
                    <li onclick="show('menu2','change2')">
                        <h3><span  id="change2">+</span>分类管理</h3>
                        <dl id="menu2" style="display:none;">
                        	<dd><a href="addCategory.php" target="mainFrame">添加分类</a></dd>
                            <dd><a href="listCategory.php" target="mainFrame">分类列表</a></dd>
                        </dl>
                    </li>
                    <li onclick="show('menu3','change3')">
                        <h3><span   id="change3" >+</span>订单管理【空空的】</h3>
                        <dl id="menu3" style="display:none;">
                            <dd><a href="#">都说空空的你还点进来看！</a></dd>
                        </dl>
                    </li>
                    <li onclick="show('menu4','change4')">
                        <h3><span  id="change4">+</span>用户管理</h3>
                        <dl id="menu4" style="display:none;">
                        	<dd><a href="addUser.php" target="mainFrame">添加用户</a></dd>
                            <dd><a href="listUser.php" target="mainFrame">用户列表</a></dd>
                        </dl>
                    </li>
                    <li onclick="show('menu5','change5')">
                        <h3><span  id="change5">+</span>管理员管理</h3>
                    ...
                    <li onclick="show('menu6','change6')">
                        <h3><span  id="change6">+</span>商品图片管理</h3>
