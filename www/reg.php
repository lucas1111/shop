	...
	<body>
		...
		<div class="regBox">
			...
			<form method="post" enctype="multipart/form-data" action="doAction.php?act=reg" >
				<ul class="login">
					<li>
						<span class="reg_item"><i>*</i>用户名：</span>
					...
					<li>
						...
						<div class="input_item">
							<input type="password"  name="password"  placeholder="请输入密码" class="login_input user_icon"required="required">
						</div>
					</li>
					<li>
					...
					<li>
						<span class="reg_item"><i>*</i>头像：</span>
						<div class="input_item">
